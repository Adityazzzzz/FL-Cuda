...
if __name__ == '__main__':
    ...
    parser.add_argument('--ea', type=lambda x:bool(strtobool(x)), default=True, help='if true, EA was performed on each subject data')
    ...
    parser.add_argument('--early', type=lambda x:bool(strtobool(x)), default=False, help='if true, early stopping')
    ...
    parser.add_argument('--fedprox', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform fedprox')
    parser.add_argument('--mu', type=float, default=1.0, help='mu for fedprox')
    parser.add_argument('--scaffold', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform scaffold')
    parser.add_argument('--moon', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform moon')
    ...
    parser.add_argument('--fedfa', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform fedfa')
    parser.add_argument('--prob', type=float, default=0.5, help='probability for fedfa')
    parser.add_argument('--GA', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform GA')
    parser.add_argument('--step_size', type=float, default=0.05, help='the step size of GA')
    parser.add_argument('--fedbs', type=lambda x:bool(strtobool(x)), default=False, help='if true, perform fedbs')
